...
$sql="update tblcarmotorbikehire set PackageName=:pname,PackageType=:ptype,PackageLocation=:plocation,PackagePrice=:pprice,PackageFetures=:pfeatures,PackageDetails=:pdetails where PackageId=:pid";
...
<?php 
$pid=intval($_GET['pid']);
$sql = "SELECT * from tblcarmotorbikehire where PackageId=:pid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
